...
function rawItem(revision = "3") {
  return {
    ...
    pipelineStageId: "00000000-0000-4000-8000-000000000102",
...
function detailFor(item: LeadWorkItem, closed = false) {
  const lead = {
    ...
    latestCycle: {
      ...
      pipelineId: "00000000-0000-4000-8000-000000000101",
      pipelineStageId: "00000000-0000-4000-8000-000000000102",
      startingPipelineStageId: "00000000-0000-4000-8000-000000000102",
      ...
      stageAtClosePipelineStageId: closed
        ? "00000000-0000-4000-8000-000000000102"
        : null,
      stageAtCloseName: closed ? "Novo" : null,
      lostReason: null,
      archiveReason: null,
      reasonNote: null,
